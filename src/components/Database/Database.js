...

{
        ...
        button:'CommingSoon',
        name:'OMINIVIEW',
        description:"Introducing OMINIVIEW! I've built a cutting-edge platform for telecommunications, solar energy, and electronics repair using React, Node.js, Express, and MongoDB.",
